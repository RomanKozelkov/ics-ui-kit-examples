...
/** Помесячные ряды текущего/прошлого года + YoY%. Готовит `useTrendChartView` дашборда. */
...
/**
 * Презентационный график тренда: помесячная динамика CY/PY + YoY% столбиками.
 * Данные приходят пропсами — стор/запросы живут в обёртке дашборда.
 */
export function TrendChart({ title, year, fmt, data, isStale }: TrendChartProps) {
