...
export function SidebarHeader() {
	return (
		<div className="group/header flex items-center gap-1 px-2 py-3 pr-4">
			<IconButton icon={Grip} size="sm" variant="ghost" className="shrink-0 rounded-md p-2" iconClassName="size-4" />
			...
			<IconButton icon={Search} size="sm" variant="ghost" className="shrink-0 rounded-md p-2" iconClassName="size-4" />
		</div>
	);
}
