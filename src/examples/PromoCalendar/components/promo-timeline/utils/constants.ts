...
/** Отступ edge-стрелки навигации к off-screen промо от края видимой области, px. */
export const EDGE_ARROW_GAP = 4;
...
/** Запас сверху для подсказки даты края (высота чипа + зазор), px. Меньше — флипаем чип под бар. */
export const EDGE_LABEL_CLEARANCE_PX = 24;
