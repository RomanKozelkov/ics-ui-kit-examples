...
import { Code, ExternalLink, GitGraph, Pencil } from "lucide-react";
...
export function ComponentHeader({
	...
	return (
		<div className="flex items-center py-2 bg-background h-8 gap-4">
			<Tabs
				value={activeTab}
			...
			<div className="ml-auto flex items-center gap-2">
				<Tooltip>
					<TooltipTrigger asChild>
						<IconButton icon={ExternalLink} size="sm" variant="outline" />
					</TooltipTrigger>
